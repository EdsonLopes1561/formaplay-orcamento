...
const getProdutoConteudo = (nome: string): string[] => {
  const k = (nome || '').toLowerCase();
  if (k.includes('premium')) return ['Tabuleiro premium', 'Cartas operacionais premium', 'Peões personalizados', '1 Dado', 'Manual especial do jogo', 'Caixa rígida premium'];
  if (k.includes('kids')) return ['Tabuleiro infantil', 'Cartas coloridas', 'Peças educativas', 'Manual infantil', 'Dinâmicas lúdicas'];
  if (k.includes('logístico') || k.includes('logistico')) return ['Tabuleiro premium', 'Cartas operacionais', 'Peões personalizados', '1 Dado', 'Manual do jogo', 'Dinâmicas educacionais'];
        ...
        <div className="print-client-grid" style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr 1.4fr', gap: '4px 16px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <div className="print-field">
              ...
              <span className="print-value">{formatarCampoCliente(clienteData?.nome_fantasia || orcamento.cliente_nome_fantasia)}</span>
            </div>
            <div className="print-field">
            ...
            <div className="print-field">
              ...
              <span className="print-value">{formatarCampoCliente(clienteData?.inscricao_estadual || orcamento.cliente_inscricao_estadual)}</span>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <div className="print-field">
              ...
              <span className="print-value">{formatarCampoCliente(clienteData?.contato_responsavel || orcamento.cliente_contato_responsavel)}</span>
            </div>
            <div className="print-field">
