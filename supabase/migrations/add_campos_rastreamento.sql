-- Migration: Adicionar campos de entrega e rastreamento
-- Arquivo: supabase/migrations/add_campos_rastreamento.sql

-- 1. Adicionar colunas na tabela orcamentos
...
ADD COLUMN IF NOT EXISTS observacao_entrega_publica text;

-- 2. Atualizar a RPC para retornar os novos campos
